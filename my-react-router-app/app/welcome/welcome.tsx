...
export function Welcome() {
  return (
    <main className="relative flex items-center justify-center pt-16 pb-4">
      ...
      <details className="fixed right-4 bottom-4 z-50">
        <summary
        ...
        <div
          className="absolute right-0 bottom-12 flex h-[40rem] w-96 flex-col rounded-lg border border-gray-300 bg-white p-3 shadow-md"
        >
